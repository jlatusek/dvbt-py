...
def test_find_symbol(symbols):
    ...
    frame2_idx = tps.find_frame_start(tps_bits[frame1_idx :], 1)
    frame3_idx = tps.find_frame_start(tps_bits[frame1_idx + frame2_idx :], 2)
    assert frame2_idx == 68
    assert frame3_idx == 68
